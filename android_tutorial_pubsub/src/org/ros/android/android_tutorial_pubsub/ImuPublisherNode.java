...
/**
 * Contributors Reuben John, Kaushik Nath
 */
...
public class ImuPublisherNode extends AbstractNodeMain {
    ...
    private boolean isAccelerometerMessagePending = false,
    ...
    public void onStart(final ConnectedNode connectedNode) {
        ...
        connectedNode.executeCancellableLoop(new CancellableLoop() {
            ...
            sensor_msgs.Imu imuMessage = imuPublisher.newMessage();
...
//                    Log.d("ImuPub", "(vRoll,vPitch,vYaw) = (" +
//                                    imuMessage.getAngularVelocity().getX() + "," +
//                                    imuMessage.getAngularVelocity().getY() + "," +
//                                    imuMessage.getAngularVelocity().getZ()
//                    );
